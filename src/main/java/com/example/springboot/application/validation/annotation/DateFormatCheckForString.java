package com.example.springboot.application.validation.annotation;
...
public @interface DateFormatCheckForString {
	...
	String message() default "{com.example.springboot.application.validation.annotation.DateFormatCheckForString.message}";
