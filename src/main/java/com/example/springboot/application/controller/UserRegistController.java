...
import com.example.springboot.application.helper.UserRegistHelper;
import com.example.springboot.application.validation.component.UserRegistFormValidator;
...
public class UserRegistController {
	...
	public String post(
			...
			@Validated @ModelAttribute UserRegistForm form, BindingResult result, Model model, Locale locale) {
		if (result.hasErrors()) {
			setInputItemAttributes(form, model, locale);
			return "content/UserRegist";
		} else {
