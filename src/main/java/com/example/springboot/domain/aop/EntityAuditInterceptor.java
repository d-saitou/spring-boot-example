...
import com.example.springboot.utility.StringUtility;
...
public class EntityAuditInterceptor {
	 ...
	 * @throws Throwable
	 */
	@Before("execution(public * com.example.springboot.domain.repository.*Mapper.create*(..)) || "
			+ "execution(public * com.example.springboot.domain.repository.*Mapper.update*(..))")
