...
public class MethodLoggingInterceptor {
	 ...
	 */
	@Pointcut("execution(public * com.example.spring..*Controller.*(..))")
	public void controllerPointCut() {}

	/**
	 * Named pointcut. (Service class)
	 */
	@Pointcut("execution(public * com.example.spring..*Service*.*(..))")
	 ...
	 * @param jp JoinPoint object.
	 */
	// @After("execution(public * com.example.spring..*Controller.*(..))")
...
//	 * @param jp JoinPoint object.
//	 */
//	@AfterReturning("execution(public * com.example.spring..*Controller.*(..))")
...
//	 */
//	@AfterThrowing(
//			value = "execution(public * com.example.spring..*Controller.*(..))", throwing = "e")
...
//	 */
//	@Around("execution(public * com.example.spring..*Controller.*(..))")
